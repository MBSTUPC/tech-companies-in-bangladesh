...
|Data Edge Limited
|Sadharan Bima Bhaban-2 (11th & 13th floor) 139 Motijheel C.A, Dhaka-1000, Corporate Office: House # 10, Road # 3 Baridhara J Block, Dhaka 1212
|C#, .NET Framework, ASP.NET(WebForms), Microsoft SQL, SQL Server, React
|https://www.data-edge.com/[Website]
