...
|Arraytics
|House 666, 668 Rd No 9, Mirpur DOHS, Dhaka, Bangladesh, 1216
|WordPress, PHP, Laravel, NodeJs, ReactJs, Ionic, Google NLP, Docker, and OpenAI GPT-3
|https://arraytics.com[Website]
https://www.linkedin.com/company/arraytics/[LinkedIn]
|30+
...
https://www.linkedin.com/company/bondstein/[LinkedIn]
https://www.facebook.com/bondsteinbd/[Facebook]
https://x.com/bondsteinbd/[Twitter]
|60+
...
|Java, Spring Boot, JavaScript, React, Next.js, Android, iOS, Flutter
...
|Java, Spring Boot, Node.js (Hapi), Hibernate, React, Next.js, AngularJS, Android, iOS
...
|Node, React, Angular, Next.js, NestJS, PHP, Laravel, AWS, Docker, Mongo, PostgreSQL, MySQL/MariaDB, Google Firebase, Flutter, WordPress, Cypress, UI/UX
...
|Node.js, Express.js, Python, Django, Go, REST, Microservices, SQL, NoSQL, SQS, SNS, MQTT
|https://evaly.com.bd/career/[Website]
|Please update

|Exabyting Technologies
|8th Floor, House# 470, Road# 31, Mohakhali DOHS, Dhaka 1212, Bangladesh
|Java, Spring, PHP, Laravel, JavaScript, Node.js, Express.js, Python, Django, REST, Microservices, SQL, NoSQL, SQS, SNS
...
|Fieldnation (USA)
|Sector 12, Uttara, Dhaka, Bangladesh, at 23 Shah Madum Avenue, 1230.
|AWS, Docker, Kubernetes, PHP, React, Node.js, TypeScript
|https://jobs.lever.co/fieldnation?location=Dhaka[Website]
|118
...
|Inument
|House# 527 (3rd floor), Road# 10 (East), Baridhara DOHS
|Dotnet, Javascript, Java, NodeJS, PHP, React, Flutter, AI/ML, NopCommerce
|https://inument.com/careers/#available-jobs[Website]
|Please update
...
|IMpulse (BD) Ltd
|House 168 (3rd Floor), Eastern Road, DOHS Baridhara, Dhaka 1206
|.Net, JavaScript, PostgreSQL
|https://www.impulsebdltd.com[Website]
|10
...
|Mediusware Ltd.
|_Bangladesh Office:_ 24/1, Taj Mahal Road, Shiya Masjid Mor, Floor - 8th & 9th, Ring Road, Dhaka 1207, Bangladesh +

_USA Office:_ Mount Pleasant, South Carolina 29464, USA
|Frontend: JavaScript, TypeScript, React, Next.js, Vue.js, Angular, HTML5, CSS3, Tailwind, UI/UX Design
Backend: Node.js, Django, PHP, Laravel, Python, REST, GraphQL, Microservices
Mobile & AR/VR: Android, iOS, React Native, Flutter, Unity
...
|https://www.mediusware.com/[Website]
https://www.facebook.com/mediusware/[Facebook]
https://www.linkedin.com/company/mediusware/[LinkedIn]
|100+
...
|https://onecodesoft.com[Website] https://www.linkedin.com/company/onecodesoft[LinkedIn]
|10+
...
|OrvionSoft
|1/1, Momin Soroni, North Ibrahimpur, Kafrul, Dhaka - 1216
|C#, ASP.NET Core, Angular, React, NextJS, PHP, Laravel, Android App, NodeJS
|https://www.orvionsoft.com/[Website]
|5
...
|Android, IOS, Go, PHP, Kubernetes, Nodejs
...
https://www.linkedin.com/company/singularity-limited/[LinkedIn]
https://www.facebook.com/singularity.ltd/[Facebook]
|60+
...
|SOFTBOFFIN
|Vaivai Market, Challabon,Dakshinkhan, Dhaka
|PHP, Laravel, Wordpress, Reactjs, NextJS
|https://www.softboffin.com [Website]
|Please update

|Software Lighthouse
|https://maps.app.goo.gl/zzyezJTjAi7hVZt89[Flat#1-B, House#12, Road# 2/A, Diabari, Uttara, Dhaka - 1230, Bangladesh].  01758561131 
|Go, Flutter, Android, iOS, Unity, Firebase, PostgresSQL, JavaScript, Oracle, Node, PHP, MySQL, WordPress 
...
|Team: 13 Software Developer: 8, SQA: 2, Designer: 1, PM & HR: 2 (Male:Female: 7:6)
...
|SPeeddigit PVT.Ltd
|House: 8, Road: 13/A, Sector: 06, Uttara, Dhaka 1230
|PHP, Laravel, Wordpress, Reactjs, NextJS
|https://www.speeddigit.com [Website]
|Please update
